...
export class EventStore {
    ...
    append(input, retry = 0) {
        ...
        if (!['explicit', 'generated_explicit_timezone', 'generated_project_timezone', 'generated_host_timezone', 'generated_utc_fallback', 'legacy_unknown'].includes(localDateSource))

...
import { migration_0054 as topologySemantics, topologyIntegritySatisfied, } from './v3_7_4/0054_topology_semantic_integrity.js';
import { migration_0055 as topologyFinalization, topologyFinalizationSatisfied, } from './v3_7_4/0055_topology_scope_finalization.js';
import { migration_0056 as isolationFinalization, projectIsolationFinalizationSatisfied, } from './v3_7_4/0056_project_isolation_finalization.js';
import { migration_0057 as isolationCompensation, projectIsolationCompensationSatisfied, } from './v3_7_4/0057_project_isolation_compensation.js';
import { migration_0058 as isolationGuards, projectIsolationRuntimeGuardsSatisfied, } from './v3_7_4/0058_project_isolation_runtime_guards.js';
import { migration_0059 as executionGuards, projectExecutionAndProvenanceGuardsSatisfied, } from './v3_7_4/0059_project_execution_and_provenance_guards.js';
import { migration_0060 as projectionReliability, } from './v3_7_4/0060_execution_projection_and_atlas_reliability.js';
import { atlasProjectionDirtyTriggersV3Satisfied, installAtlasProjectionDirtyTriggersV3, migration_0061 as runtimeScopeIntegrity, } from './v3_7_4/0061_runtime_scope_and_projection_integrity.js';
import { migration_0062 as outboxRecovery, projectionScopeAndOutboxRecoverySatisfied, } from './v3_7_4/0062_projection_scope_and_outbox_recovery.js';
const INSTALL_STEPS = [
...
function preservePreTransitionTaskIdentity(db) {

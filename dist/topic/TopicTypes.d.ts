...
export type TopicOperationType = 'USER_DEFINED_TOPIC_CREATE' | 'USER_DEFINED_TOPIC_RENAME' | 'USER_DEFINED_TOPIC_ALIAS' | 'USER_DEFINED_TOPIC_MOVE' | 'USER_DEFINED_TOPIC_MERGE' | 'USER_DEFINED_TOPIC_SPLIT' | 'USER_DEFINED_TOPIC_REASSIGN' | 'USER_DEFINED_TOPIC_RELATION_ADD' | 'USER_DEFINED_TOPIC_RELATION_REMOVE' | 'MODEL_PROPOSED_TOPIC' | 'MODEL_PROPOSED_TOPIC_ALIAS' | 'MODEL_PROPOSED_TOPIC_RELATION' | 'SYSTEM_REPAIR_TOPIC';

function buildCorrectionContent(original) {
...
export function injectContradictions(base) {
    ...
    for (const issueTurn of issueTurns) {
        ...
        if (recallCase) {
            ...
            recallCase.relevantPhrases = Array.from(new Set([...recallCase.relevantPhrases.filter((item) => item !== 'left ear has static'), 'right ear has static']));

...
function parseAliases(value) {
    try {
        ...
        return Array.from(new Set(Array.isArray(parsed) ? parsed.filter((item) => typeof item === 'string') : []));
    }
    catch {
        return [];
    }
...
function optionalString(value) { return typeof value === 'string' && value ? value : undefined; }

...
function usage() {
    return [
        ...
        '',
        'Starts a stdio MCP server exposing cogmem_remember_turn, cogmem_recall, cogmem_explain_recall, cogmem_strategy_plan, cogmem_memory_map, cogmem_maintenance_tick, and cogmem_prospective.',
    ].join('\n');
}
async function main() {

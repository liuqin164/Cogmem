...
import type { EpisodeCandidateType, EpisodeSemanticSummary, MemoryEpisode } from './EpisodeTypes.js';

export function summarizeEpisode(
  episode: MemoryEpisode,
  events: MemoryEvent[],
  evidenceEventIds: string[],
): EpisodeSemanticSummary {
  ...
  return {
    ...
    candidateTypes: candidateTypes as EpisodeCandidateType[],
    evidenceEventIds,

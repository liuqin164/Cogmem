...
export const MEMORY_DIMENSIONS = ['actor','entity','project','topic','issue','event','raw_event','episode','task','object','location','time','state'] as const;
export const MEMORY_FRAME_REQUIRED_DIMENSIONS = ['episode', 'project'] as const;

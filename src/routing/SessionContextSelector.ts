...
export function selectCueDrivenSessionTurns(input: SessionContextSelectionInput): SessionTurn[] {
...
export function buildCueDrivenSessionContext(input: SessionContextSelectionInput): string {
  return selectCueDrivenSessionTurns(input)
    .map(formatSessionTurn)
    .join('\n');
}

function formatSessionTurn(turn: SessionTurn): string {

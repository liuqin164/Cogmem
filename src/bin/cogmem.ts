...
function usage(): string {
  return [
    ...
    '  openclaw diagnose    inspect generated OpenClaw plugin files and hook audit without opening the DB',
    ...
    '  repair               conservative upgrade repair commands such as project-scope',
